#include<mpi.h>
#include <fstream>
#include "./microenvironment_nmpi.h"
#include "./utils.h"
...
void microenvironment::initialize_diffusion(double cube_side, double delta, int d_num, int vl){
    ...
    snd_data_size = y_size*z_size * number_of_densities; // Number of data elements to be sent
    rcv_data_size = y_size*z_size * number_of_densities; // All p_density_vectors elements have same size, use anyone

    snd_data_size_last = 0; // Number of data elements to be sent
    rcv_data_size_last = 0;
